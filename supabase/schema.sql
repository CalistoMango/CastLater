...
\restrict njOXkwPD0c1fAFTZfyeBthVplmrKNw3lH3NVysIjA7qWjUHEEh2VpmtGIlqDzDT
...
--
-- Name: increment_casts_used(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_casts_used(user_fid bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE users
...
--
-- Name: scheduled_casts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.scheduled_casts (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    fid bigint,
    ...
    CONSTRAINT scheduled_casts_content_check CHECK ((char_length(content) <= 320)),
    CONSTRAINT scheduled_casts_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'sent'::text, 'failed'::text, 'cancelled'::text])))
);
...
CREATE TABLE public.users (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT users_plan_check CHECK ((plan = ANY (ARRAY['free'::text, 'unlimited'::text])))
);
...
--
-- Name: payments payments_transaction_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scheduled_casts scheduled_casts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scheduled_casts
    ADD CONSTRAINT scheduled_casts_pkey PRIMARY KEY (id);
...
--
-- Name: users users_signer_uuid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_signer_uuid_key UNIQUE (signer_uuid);
...
--
-- Name: idx_payments_fid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payments_fid ON public.payments USING btree (fid);


--
-- Name: idx_payments_tx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payments_tx ON public.payments USING btree (transaction_hash);


--
-- Name: idx_scheduled_casts_fid_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scheduled_casts_fid_status ON public.scheduled_casts USING btree (fid, status);


--
-- Name: idx_scheduled_casts_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scheduled_casts_status ON public.scheduled_casts USING btree (status);


--
-- Name: idx_scheduled_casts_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scheduled_casts_time ON public.scheduled_casts USING btree (scheduled_time);


--
-- Name: idx_users_signer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_users_signer ON public.users USING btree (signer_uuid);
...
--
-- Name: scheduled_casts update_scheduled_casts_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_scheduled_casts_updated_at BEFORE UPDATE ON public.scheduled_casts FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: payments payments_fid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payments
    ADD CONSTRAINT payments_fid_fkey FOREIGN KEY (fid) REFERENCES public.users(fid) ON DELETE CASCADE;


--
-- Name: scheduled_casts scheduled_casts_fid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scheduled_casts
    ADD CONSTRAINT scheduled_casts_fid_fkey FOREIGN KEY (fid) REFERENCES public.users(fid) ON DELETE CASCADE;
...
--
-- Name: users Anyone can read users; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: scheduled_casts Users can insert own casts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own casts" ON public.scheduled_casts FOR INSERT WITH CHECK (true);


--
-- Name: scheduled_casts Users can read own casts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can read own casts" ON public.scheduled_casts FOR SELECT USING (true);
...
--
-- Name: scheduled_casts Users can update own casts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update own casts" ON public.scheduled_casts FOR UPDATE USING (true);
...
--
-- Name: scheduled_casts; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION increment_casts_used(user_fid bigint); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.increment_casts_used(user_fid bigint) TO anon;
GRANT ALL ON FUNCTION public.increment_casts_used(user_fid bigint) TO authenticated;
GRANT ALL ON FUNCTION public.increment_casts_used(user_fid bigint) TO service_role;
...
--
-- Name: TABLE scheduled_casts; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.scheduled_casts TO anon;
GRANT ALL ON TABLE public.scheduled_casts TO authenticated;
GRANT ALL ON TABLE public.scheduled_casts TO service_role;
...
\unrestrict njOXkwPD0c1fAFTZfyeBthVplmrKNw3lH3NVysIjA7qWjUHEEh2VpmtGIlqDzDT
